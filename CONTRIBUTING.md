# Contributing to PROJECT_SPRINT

First off, thanks for taking the time to contribute!

## Code of Conduct

This project and everyone participating in it is governed by the [PROJECT_SPRINT Code of Conduct](https://github.com/plankanban/planka/blob/master/CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code.
...
If you’re looking for ways to get started, here's a list of ways to help us improve PROJECT_SPRINT:
