...
### 1. Scope and Your Relationship with PROJECT_SPRINT

#### 1.1 What This Document Covers
These End User Terms of Service apply to you as an end user of the cloud-based PROJECT_SPRINT software (SaaS). They govern the conditions under which you may use the software – regardless of whether you are an employee, external contractor, or invited user of the organization that has made PROJECT_SPRINT available to you.

#### 1.2 Who Is Who?
- **"Provider"** or **"we"**: PROJECT_SPRINT Software GmbH, Lindauer Str. 4, 87439 Kempten, Germany
- **"Customer"** or **"Instance Administrator"**: The organization that has entered into an agreement with us for the provision of PROJECT_SPRINT
- **"You"** or **"End User"**: The natural person using PROJECT_SPRINT through the Customer's account

#### 1.3 Contractual Framework
Your access to PROJECT_SPRINT is based on the agreement between the Customer and us (Terms and Conditions). This document supplements those Terms and Conditions and governs your personal obligations as an end user. It does not establish an independent contractual relationship between you and the Provider.
...
#### 3.1 Intended Use
You may use PROJECT_SPRINT exclusively for the purposes for which the Customer has granted you access, and within the scope of the role and permissions assigned to you.
...
You are responsible for all content you create, upload, or share in PROJECT_SPRINT. Ensure that such content does not infringe the rights of third parties and complies with applicable law.

### 4. Intellectual Property and Your Content

The PROJECT_SPRINT software is owned by PROJECT_SPRINT Software GmbH. Your authorization to use the software does not constitute a transfer of ownership rights. You retain ownership of all content you create within PROJECT_SPRINT. The management and any release of your content is the responsibility of the Customer (instance administrator), not the Provider.

### 5. Availability, Liability, and Data Backup

The Provider endeavors to provide PROJECT_SPRINT with high availability. However, maintenance, technical disruptions, or force majeure events may result in temporary limitations. There is no entitlement to uninterrupted availability.
...
Access credentials, license information, and internal data to which you gain access through PROJECT_SPRINT must be treated as confidential. The confidentiality obligation continues beyond the duration of your access authorization.
...
The Provider may amend these End User Terms of Service with effect for the future. Changes will be displayed to you at your next login and require your renewed confirmation. Without confirmation, further use of PROJECT_SPRINT is not possible. German law applies.
...
**Data Controller** for data processing within your PROJECT_SPRINT instance is your employer or client (the "Instance Administrator"). They determine which data is processed in PROJECT_SPRINT.

**PROJECT_SPRINT Software GmbH** (Lindauer Str. 4, 87439 Kempten, Germany) processes your data as a data processor on behalf of the Instance Administrator.

For data protection inquiries, please contact your instance administrator or reach us at: privacy@planka.group

### 2. What Data Is Processed?

When using PROJECT_SPRINT, we process the following data on behalf of your instance administrator:
...
- **Your Content:** Everything you create, upload, or share in PROJECT_SPRINT (boards, cards, comments, attachments)
...
- **PROJECT_SPRINT Software GmbH** (as data processor)
...
PROJECT_SPRINT uses only technically necessary cookies (session and login cookies). Tracking or marketing cookies are not used.
...
*PROJECT_SPRINT Software GmbH · Lindauer Str. 4 · 87439 Kempten · Germany*
