...
export default {
  ...
  translation: {
    common: {
      ...
      aboutPlanka_title: '關於 PROJECT_SPRINT',
      accessToken: '存取權杖',
      account: '帳號',
      actions: '操作',
      ...
      discoverPlankaPro: '✨ 為您的看板提供更多功能：探索 PROJECT_SPRINT Pro',
      discoverPlankaPro_title: '探索 PROJECT_SPRINT Pro',
      ...
      plankaUsesAppriseToSendNotificationsToOver100PopularServices:
        'PROJECT_SPRINT 使用 <1><0>Apprise</0></1> 向超過 100 個熱門服務發送通知。',
      port: '連接埠',
      preferences: '偏好設定',
