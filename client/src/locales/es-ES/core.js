...
export default {
  ...
  translation: {
    common: {
      ...
      aboutPlanka_title: 'Acerca de PROJECT_SPRINT',
      ...
      discoverPlankaPro: '✨ Más funciones para tus tableros: Descubre PROJECT_SPRINT Pro',
      discoverPlankaPro_title: 'Descubre PROJECT_SPRINT Pro',
      ...
      plankaUsesAppriseToSendNotificationsToOver100PopularServices:
        'PROJECT_SPRINT usa <1><0>Apprise</0></1> para enviar notificaciones a más de 100 servicios populares.',
      port: 'Puerto',
