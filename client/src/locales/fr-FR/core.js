...
export default {
  ...
  translation: {
    common: {
      ...
      aboutPlanka_title: 'À propos de PROJECT_SPRINT',
      ...
      discoverPlankaPro: '✨ Plus de fonctionnalités pour vos tableaux : Découvrez PROJECT_SPRINT Pro',
      discoverPlankaPro_title: 'Découvrez PROJECT_SPRINT Pro',
      ...
      plankaUsesAppriseToSendNotificationsToOver100PopularServices:
        'PROJECT_SPRINT utilise <1><0>Apprise</0></1> pour envoyer des notifications vers plus de 100 services populaires.',
      port: 'Port',
