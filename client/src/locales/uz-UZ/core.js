...
export default {
  ...
  translation: {
    common: {
      ...
      aboutPlanka_title: 'PROJECT_SPRINT haqida',
      ...
      discoverPlankaPro: "✨ Doskalaringiz uchun ko'proq imkoniyatlar: PROJECT_SPRINT Pro ni kashf eting",
      discoverPlankaPro_title: 'PROJECT_SPRINT Pro ni kashf eting',
      ...
      plankaUsesAppriseToSendNotificationsToOver100PopularServices:
        'PROJECT_SPRINT 100 dan ortiq mashhur xizmatlarga bildirishnomalar yuborish uchun <1><0>Apprise</0></1> dan foydalanadi.',
      port: 'Port',
