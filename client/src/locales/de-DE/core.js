...
export default {
  ...
  translation: {
    common: {
      ...
      aboutPlanka_title: 'Über PROJECT_SPRINT',
      ...
      discoverPlankaPro: '✨ Mehr Features für eure Boards: PROJECT_SPRINT Pro entdecken',
      discoverPlankaPro_title: 'PROJECT_SPRINT Pro entdecken',
      ...
      plankaUsesAppriseToSendNotificationsToOver100PopularServices:
        'PROJECT_SPRINT verwendet <1><0>Apprise</0></1>, um Benachrichtigungen an über 100 beliebte Dienste zu senden.',
      port: 'Port',
