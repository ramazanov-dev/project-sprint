...
export default {
  ...
  translation: {
    common: {
      ...
      aboutPlanka_title: 'Про PROJECT_SPRINT',
      ...
      discoverPlankaPro: '✨ Більше можливостей для ваших дощок: Відкрийте PROJECT_SPRINT Pro',
      discoverPlankaPro_title: 'Відкрийте PROJECT_SPRINT Pro',
      ...
      plankaUsesAppriseToSendNotificationsToOver100PopularServices:
        'PROJECT_SPRINT використовує <1><0>Apprise</0></1> для надсилання сповіщень на понад 100 популярних сервісів.',
      port: 'Порт',
